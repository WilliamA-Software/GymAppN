...
import 'registryInfoPersonal.dart';

class RegistryContinue extends StatefulWidget {
  @override
  _RegistryContinueState createState() => _RegistryContinueState();
}

class _RegistryContinueState extends State<RegistryContinue> {
              ...
              new Container(
                ...
                child: Column(
                    ...
                    Container(
                        ...
                        alignment: Alignment.center, // Alinear a la izquierda (i.e .centerRight, centerLeft)
                        child: Text(    //añadir texto
                            "Fase 1: Terminar de completar mi perfil",
                            style: new TextStyle(
                            fontSize:16.0,
                            color: const Color(0xFF000000),
                            fontFamily: "Open Sans",
                    ...
                    SizedBox(
                        ...
                        onPressed: (){
                            Navigator.push(
                              context,
                              CupertinoPageRoute(builder: (context) => InformationPersonal()),
                          );
                        },
